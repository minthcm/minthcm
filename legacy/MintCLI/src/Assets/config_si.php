...
//   'dbUSRData' => 'create',
    ...
    'setup_system_mode' => 'normal',
    'setup_system_mode_restriced_modules' => ['ModuleBuilder', 'UpgradeWizard', 'Schedulers', 'OAuth2Clients', 'OAuthKeys', 'Connectors', 'Studio'],
    'setup_system_mode_restriced_administration_actions' => ['UpgradeWizard', 'SearchSettings'],
    'setup_system_mode_restriced_panel_defs' => [
        'oauth2_clients',
        'oauth_keys',
        'upgrade_wizard',
        'module_loader',
