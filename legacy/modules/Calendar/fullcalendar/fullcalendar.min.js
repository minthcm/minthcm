...
(function webpackUniversalModuleDefinition(root,factory){if(typeof exports==='object'&&typeof module==='object')
    ...
    EventPointing.prototype.bindToEl=function(el){var component=this.component;component.bindSegHandlerToEl(el,'click',this.handleClick.bind(this));component.bindSegHandlerToEl(el,'mouseenter',this.handleMouseover.bind(this));component.bindSegHandlerToEl(el,'mouseleave',this.handleMouseout.bind(this));component.bindSegHandlerToEl(el,'auxclick',this.handleAuxclick.bind(this))};EventPointing.prototype.handleAuxclick=function(seg,ev){if(ev.button==2){return}
    var res=this.component.publiclyTrigger('eventAuxclick',{context:seg.el[0],args:[seg.footprint.getEventLegacy(),ev,this.view]});if(res===!1){ev.preventDefault()}}
    EventPointing.prototype.handleClick=function(seg,ev){if(ev.ctrlKey){var res=this.component.publiclyTrigger('eventAuxclick',{context:seg.el[0],args:[seg.footprint.getEventLegacy(),ev,this.view]})}else{var res=this.component.publiclyTrigger('eventClick',{context:seg.el[0],args:[seg.footprint.getEventLegacy(),ev,this.view]})}
    if(res===!1){ev.preventDefault()}};EventPointing.prototype.handleMouseover=function(seg,ev){if(!GlobalEmitter_1.default.get().shouldIgnoreMouse()&&!this.mousedOverSeg){document.body.onmousedown=function(e){if(e.button===1)return!1}
