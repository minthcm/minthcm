                        ...
                        // 2013-03-19 handle Chart Function properly Bug #448
                        {
                            switch ($thisDataSeries['chartfunction']) {
                                case 'MAX':
                                    ...
                                    break;
                                case 'MIN':
                                    if ($thisResultRecord[$thisDataSeries['fieldid']] < $chartData[$thisDataSeries['fieldid']]['value'] || 0 == $chartData[$thisDataSeries['fieldid']]['value']) {
                                        $chartData[$thisDataSeries['fieldid']]['value'] = (float) $thisResultRecord[$thisDataSeries['fieldid']];
                                    }
                        ...
                        // 2013-03-19 handle Chart Function properly Bug #448
                        {
                            switch ($thisDataSeries['chartfunction']) {
                                case 'MAX':
                                    ...
                                    break;
                                case 'MIN':
                                    if (0 == $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisDataSeries['fieldid']] || $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisDataSeries['fieldid']] > $thisResultRecord[$thisDataSeries['fieldid']]) {
                                        $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisDataSeries['fieldid']] = (float) $thisResultRecord[$thisDataSeries['fieldid']];
                                    }
                            ...
                            // 2013-03-19 handle Chart Function properly Bug #448
                            {
                                switch ($thisDataSeries['chartfunction']) {
                                    case 'MAX':
                                        ...
                                        break;
                                    case 'MIN':
                                        if (0 == $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisResultRecord[$dimensions[1]['fieldid']]] || $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisResultRecord[$dimensions[1]['fieldid']]] < $thisResultRecord[$thisDataSeries['fieldid']]) {
                                            $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisResultRecord[$dimensions[1]['fieldid']]] = (float) $thisResultRecord[$thisDataSeries['fieldid']];
                                        }
                        ...
                        // 2013-03-19 handle Chart Function properly Bug #448
                        {
                            switch ($thisDataSeries['chartfunction']) {
                                case 'MAX':
                                    ...
                                    break;
                                case 'MIN':
                                    if (0 == $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisResultRecord[$dimensions[1]['fieldid']]][$thisResultRecord[$dimensions[2]['fieldid']]] || $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisResultRecord[$dimensions[1]['fieldid']]][$thisResultRecord[$dimensions[2]['fieldid']]] < $thisResultRecord[$thisDataSeries['fieldid']]) {
                                        $chartData[$thisResultRecord[$dimensions[0]['fieldid']]][$thisResultRecord[$dimensions[1]['fieldid']]][$thisResultRecord[$dimensions[2]['fieldid']]] = (float) $thisResultRecord[$thisDataSeries['fieldid']];
                                    }
...
//              }
        ...
        if (0 == $dimCount) {
            ...
            if (!in_array($chartParams['type'], $keepDimensionsForTypes)) {
                unset($dimensions[1]);
            }
