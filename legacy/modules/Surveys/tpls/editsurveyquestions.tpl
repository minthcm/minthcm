<div>
    ...
    <button type="button" class="button" id="newQuestionButton">{$MOD.LBL_NEW_QUESTION}</button>
    {* View Tools END *}
</div>
{literal}
    <script>
    ...
    {*newRow += "<strong>Options</strong>";*}
              newRow += "<strong>" + viewTools.language.get( 'Surveys', 'LBL_OPTIONS' ) + "</strong>";
    {* View Tools END *}
    {literal}
    ...
    {*newRow += "<button class='addOptionButton button' data-question-index='" + createQuestion.questionCount + "' type='button'>Add option</button>";*}
              newRow += "<button class='addOptionButton button' data-question-index='" + createQuestion.questionCount + "' type='button'>" + viewTools.language.get( 'Surveys', 'LBL_ADD_OPTION' ) + "</button>";
    {* View Tools END *}
    {literal}
              newRow += "</td>";
              newRow += "<td>";
