...
$mod_strings = array(
   ...
   'LBL_SAML_NAMEID_FORMAT' => 'NameID Format',
   'LBL_SAML_NAMEID_FORMAT_DESC' => 'Optional field. Allows overriding the SAML NameID format value. NameId has to be equal to user`s user_name value. If not specified, the default urn:oasis:names:tc:SAML:1.1:nameid-format:emailAddress will be used.',
   ...
   // OIDC Authentication
   'LBL_OIDC_TITLE' => 'OpenID Connect (OIDC) Authentication',
   'LBL_OIDC_ENABLE' => 'Enable OIDC Authentication',
   'LBL_OIDC_HELP_TXT' => 'When OpenID Connect authentication is enabled, users are redirected to the IdP for authentication. The MintHCM Password Management settings do not apply.',
   'LBL_OIDC_CLIENT_ID' => 'Client ID',
   'LBL_OIDC_CLIENT_ID_DESC' => 'OAuth 2.0 client identifier registered with the IdP.',
   'LBL_OIDC_CLIENT_SECRET' => 'Client Secret',
   'LBL_OIDC_CLIENT_SECRET_DESC' => 'OAuth 2.0 client secret. Stored in config.php.',
   'LBL_OIDC_AUTHORIZATION_ENDPOINT' => 'Authorization Endpoint',
   'LBL_OIDC_AUTHORIZATION_ENDPOINT_DESC' => 'Full URL of the IdP authorization endpoint (e.g. https://idp.example.com/authorize).',
   'LBL_OIDC_TOKEN_ENDPOINT' => 'Token Endpoint',
   'LBL_OIDC_TOKEN_ENDPOINT_DESC' => 'Full URL of the IdP token endpoint used for the authorization_code exchange.',
   'LBL_OIDC_LOGOUT_ENDPOINT' => 'End-Session Endpoint (optional)',
   'LBL_OIDC_LOGOUT_ENDPOINT_DESC' => 'Optional. Full URL of the IdP end-session endpoint for RP-Initiated Logout.',
   'LBL_OIDC_SCOPE' => 'Scope',
   'LBL_OIDC_SCOPE_DESC' => 'Space-separated list of OIDC scopes to request. Default: openid profile email.',
   'LBL_OIDC_USERNAME_CLAIM' => 'Username Claim',
   'LBL_OIDC_USERNAME_CLAIM_DESC' => 'ID-token claim whose value matches the MintHCM user_name field. Default: preferred_username.',
