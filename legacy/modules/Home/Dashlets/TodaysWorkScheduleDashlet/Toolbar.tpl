        ...
        <div class="toolbar_container">
                <div class="dateTime toolbar_container__date_time">
                    <div class="monthHeader toolbar_container__date_time__month_header_left">
                        <a href="javascript:void(0)" class="calendar_before" onkeydown="{literal}if(event.key===' '){event.preventDefault();this.click();}{/literal}">
                    ...
                    <img class="calendar_img toolbar_container__date_time__calendar_img" tabindex="0" role="button" onkeydown="{literal}if(event.key===' '||event.key==='Enter'){event.preventDefault();this.click();}{/literal}" src="themes/SuiteP/images/jscalendar.gif" alt="{$APP.twsdashlet_insert_date}">
                    <div class="monthHeader toolbar_container__date_time__month_header_right">
                        <a class="calendar_next" href="javascript:void(0)" onkeydown="{literal}if(event.key===' '){event.preventDefault();this.click();}{/literal}">
                                <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="32px" height="32px" style="enable-background:new 0 0 32 32;" xml:space="preserve">
                                    <g id="layer1" transform="translate(0,-1036.3622)">
                ...
                <div class="toolbar_container__select_container"><select tabindex="0"></select></div>
                <div class="toolbar_container__action_buttons_container">
                    <img class="showPlanButton" tabindex="0" role="button" onkeydown="{literal}if(event.key===' '||event.key==='Enter'){event.preventDefault();this.click();}{/literal}" src="themes/SuiteP/images/twsdashlet_show_24.png" alt="{$APP.twsdashlet_show}" title="{$APP.twsdashlet_show}">
                    <img class="editPlanButton" tabindex="0" role="button" onkeydown="{literal}if(event.key===' '||event.key==='Enter'){event.preventDefault();this.click();}{/literal}" src="themes/SuiteP/images/twsdashlet_edit_24.png" alt="{$APP.twsdashlet_edit}" title="{$APP.twsdashlet_edit}">
                    <img class="logTimeButton" tabindex="0" role="button" onkeydown="{literal}if(event.key===' '||event.key==='Enter'){event.preventDefault();this.click();}{/literal}" src="themes/SuiteP/images/twsdashlet_add_time_24.png" alt="{$APP.twsdashlet_add_time}" title="{$APP.twsdashlet_add_time}">
                    {if $fields.status.value != 'closed'}
                        <img id="CloseButton" tabindex="0" role="button" onkeydown="{literal}if(event.key===' '||event.key==='Enter'){event.preventDefault();this.click();}{/literal}" src="themes/SuiteP/images/twsdashlet_close_24.png" alt="{$MOD.LBL_CLOSE_PLAN}" title="{$MOD.LBL_CLOSE_PLAN}">
