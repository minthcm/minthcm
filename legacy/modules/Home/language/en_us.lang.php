...
//ABOUT page
    ...
    'LBL_ABOUT_CHAPTER_3' => 'All-Inclusive HR Solutions\n\nOmniHR\'s Human Resource Management System encompasses the entire HR spectrum, covering seven essential functions:\n\n<ol><li>Recruitment & Selection: Streamline your hiring process with advanced tools that simplify talent acquisition and selection.</li><li>Training & Development: Nurture talent and cultivate a culture of continuous learning with our intuitive training and development modules.</li><li>Performance Management: Evaluate and enhance employee performance with data-driven insights, fostering a high-performance culture.</li><li>Employee Relations: Strengthen employee engagement and foster a positive work environment through effective communication and conflict resolution tools.</li><li>Employment Law & Compliance: Stay ahead of regulatory changes with OmniHR\'s compliance features, ensuring your HR practices align with the latest legal standards.</li><li>Compensation & Benefits: Optimize your compensation strategy and benefits administration to attract and retain top talent.</li><li>Administration and Payroll: Simplify administrative tasks and ensure accurate payroll processing with our integrated system.</li></ol>';
