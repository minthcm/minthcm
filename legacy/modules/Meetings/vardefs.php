   ...
   'fields' => array(
     ...
     array(
      ...
      'repeat_type' =>array(
         ...
         'type' => 'enum',
         'len' => 36,
         'options' => 'mint4_repeat_type_list',
      ...
      'repeat_interval_unit' =>array(
         'name' => 'repeat_interval_unit',
         'vname' => 'LBL_REPEAT_INTERVAL_UNIT',
         'type' => 'enum',
         'len' => 7,
         'comment' => 'Unit of recurrence',
         'options' => 'mint4_repeat_panel_interval_unit_list',
         'importable' => 'false',
         'massupdate' => false,
         'reportable' => false,
         'studio' => 'false',
