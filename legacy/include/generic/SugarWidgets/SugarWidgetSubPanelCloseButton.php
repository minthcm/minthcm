...
class SugarWidgetSubPanelCloseButton extends SugarWidgetField
{
    public function displayList(&$layout_def)
    {
        ...
        if ($layout_def['EditView']) {
            ...
            $html = "<a id=\"$unique_id\" onclick='SUGAR.util.closeActivityPanel.show(\"$module_name\",\"$record_id\",\"$new_status\",\"subpanel\",\"{$layout_def['subpanel_id']}\", this);' >".$app_strings['LNK_CLOSE']."</a>";
            return $html;
        } else {
            return '';
        }
