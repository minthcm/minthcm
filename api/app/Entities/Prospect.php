...
/**
 * @ORM\Entity
 * @ORM\Table(name="prospects", indexes={
 * @ORM\Index(name="prospectspk", columns={"id"}), 
 * @ORM\Index(name="prospect_auto_tracker_key", columns={"tracker_key"}), 
 * @ORM\Index(name="idx_prospects_last_first", columns={"last_name", "first_name", "deleted"}), 
 * @ORM\Index(name="idx_prospecs_del_last", columns={"last_name", "deleted"}), 
 * @ORM\Index(name="idx_prospects_id_del", columns={"id", "deleted"}), 
 * @ORM\Index(name="idx_prospects_assigned", columns={"assigned_user_id"})})
 * @property mixed $id
...
class Prospect extends MintEntity
{
