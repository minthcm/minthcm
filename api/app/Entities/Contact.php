 ...
 * @ORM\Index(name="contactspk", columns={"id"}), 
 * @ORM\Index(name="idx_cont_last_first", columns={"last_name", "first_name", "deleted"}), 
 * @ORM\Index(name="idx_contacts_del_last", columns={"deleted", "last_name"}), 
 * @ORM\Index(name="idx_cont_del_reports", columns={"deleted", "reports_to_id", "last_name"}), 
 * @ORM\Index(name="idx_reports_to_id", columns={"reports_to_id"}), 
 * @ORM\Index(name="idx_del_id_user", columns={"deleted", "id", "assigned_user_id"}), 
 * @ORM\Index(name="idx_cont_assigned", columns={"assigned_user_id"})})
 * @property mixed $id
 ...
 * @property mixed $lead_source
 * @property mixed $reports_to_id
 * @property mixed $birthdate
 * @property mixed $campaign_id
 * @property mixed $joomla_account_id
 * @property mixed $portal_account_disabled
 * @property mixed $portal_user_type
 */
// Auto-generated SectionRepository section end
class Contact extends MintEntity
{
     ...
     * @ORM\Column(type="boolean")
     */
    protected $portal_account_disabled;
