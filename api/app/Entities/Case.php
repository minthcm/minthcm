...
/**
 * @ORM\Entity
 * @ORM\Table(name="cases", indexes={
 * @ORM\Index(name="casespk", columns={"id"}), 
 * @ORM\Index(name="casesnumk", columns={"case_number"}), 
 * @ORM\Index(name="case_number", columns={"case_number"}), 
 * @ORM\Index(name="idx_case_name", columns={"name"}), 
 * @ORM\Index(name="idx_cases_stat_del", columns={"assigned_user_id", "status", "deleted"})})
 * @property mixed $id
 * @property mixed $name
 ...
 * @property mixed $contact_created_by_id
 */
// Auto-generated SectionRepository section end
class Case extends MintEntity
{
     ...
     * @ORM\Column(type="id", length="36")
     */
    protected $contact_created_by_id;
