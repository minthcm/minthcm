...
/** When navigating to edit via "Edit Cycles", block changes to the repeat config. */
const isEditCyclesMode = computed(() => recordViewStore.editCycles)
