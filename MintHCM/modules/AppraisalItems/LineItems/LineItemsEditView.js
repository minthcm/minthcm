...
function insertAppraisalItem( inline_appraisal_item_data ) {
   ...
   newField.append( $( '<select name="parent_type[' + appraisal_item_idx + ']" tabindex="0" id="parent_type' + appraisal_item_idx + '" title="" onchange="onParentChange(' + appraisal_item_idx + ')"><option label="' + SUGAR.language.get( 'app_list_strings', 'appraisal_subject_list' ).Goals + '" value="Goals">' + SUGAR.language.get( 'app_list_strings', 'appraisal_subject_list' ).Goals + '</option><option label="' + SUGAR.language.get( 'app_list_strings', 'appraisal_subject_list' ).Responsibilities + '" value="Responsibilities">' + SUGAR.language.get( 'app_list_strings', 'appraisal_subject_list' ).Responsibilities + '</option><option label="' + SUGAR.language.get( 'app_list_strings', 'appraisal_subject_list' ).Competencies + '" value="Competencies">' + SUGAR.language.get( 'app_list_strings', 'appraisal_subject_list' ).Competencies + '</option></select>' )[0] );
