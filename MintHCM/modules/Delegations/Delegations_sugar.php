 ...
 * PLACE ANY CUSTOMIZATIONS IN Delegations
 */
class Delegations_sugar extends Basic {

   public $new_schema = true;
   public $module_dir = 'Delegations';
   public $object_name = 'Delegations';
   public $table_name = 'delegations';
   ...
   public $convert_to_billing_currency;
