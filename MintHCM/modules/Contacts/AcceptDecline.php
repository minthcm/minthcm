...
// MintHCM #54195 - Obsługa akceptacji/odrzucenia zaproszenia kandydata na spotkanie/rozmowę
...
// MintHCM #54195 Start
else if ( !empty($_REQUEST['candidate_id']) ) {
   $current_entity = BeanFactory::getBean('Candidates');
   $current_entity->disable_row_level_security = true;
   $result = $current_entity->retrieve($_REQUEST['candidate_id']);
   if ( $result == null ) {
      session_destroy();
      sugar_cleanup();
      die("The candidate id doesn't exist");
   }
}
// MintHCM #54195 End
