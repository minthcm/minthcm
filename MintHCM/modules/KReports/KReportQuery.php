...
class KReportQuery {
            ...
            foreach ( $this->joinSegments as $thisPath => $thisPathDetails ) {
               ...
               if ( $thisPathDetails['level'] == $levelCounter ) {
                ...
                /* MintHCM #70811 END */
                     ...
                     // Mint start #58178
                     if ( $this->authChecklevel != 'none' && $this->authChecklevel != 'top' && isset($GLOBALS['sugar_config']['KReports']) ) {
                        // Mint end #58178
   ...
   function getWhereOperatorClause($operator, $fieldname, $fieldid, $path, $value, $valuekey, $valueto, $valuetokey = '', $jointype = '') {
      ...
      if (
         ...
         // Mint start #58178
         if ( isset($this->fieldNameMap[$fieldid]) && $this->fieldNameMap[$fieldid]['type'] === 'date' ) {
            // Mint end #58178
         ...
         // Mint start #58178
         if ( isset($this->fieldNameMap[$fieldid]) && ($this->fieldNameMap[$fieldid]['type'] === 'datetime' || $this->fieldNameMap[$fieldid]['type'] === 'datetimecombo' ) ) {
            // Mint end #58178
