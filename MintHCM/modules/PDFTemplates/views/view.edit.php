...
class PDFTemplatesViewEdit extends ViewEdit {
   ...
   function preDisplay() {
      ...
      $treefield->set_param('module', 'PDFTemplates');
      $nodes = getNodes();
      ...
      $instance_tmp = $treefield->generate_nodes_array();
      $instance = str_replace(array( '{', '}' ), array( 'openc', 'closec' ), $instance_tmp);
   ...
   public function display() {
      $this->ev->process();
      $tpl_tmp = $this->ev->display($this->showTitle);
      $tpl = str_replace(array( 'openc', 'closec' ), array( '{', '}' ), $tpl_tmp);
      echo $tpl;
   }
