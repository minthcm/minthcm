...
class LoggerManager {
   ...
   $method, $message
      ...
      if ( $method == $this->_level
              ...
              || (!empty(self::$_levelMapping[$method]) && ( (isset(self::$_levelMapping[$this->_level]) ? self::$_levelMapping[$this->_level] : null) >= (isset(self::$_levelMapping[$method]) ? self::$_levelMapping[$method] : null) ) ) ) {
